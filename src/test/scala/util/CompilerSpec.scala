...
class CompilerSpec extends WordSpec with Matchers {
  ...
  "Compiler" should {
    ...
    "compile AgeUSD v0 contract correctly" in {
      val (ergoTree, hash, address) = Compiler.compile("src/test/resources/AgeUSD_v0.es", Some("src/test/resources/AgeUSD_v0_symbols.json"))
    ...
    "compile AgeUSD v0 update contract correctly" in {
      val (ergoTree, hash, address) = Compiler.compile("src/test/resources/AgeUSD_v0_update.es", Some("src/test/resources/AgeUSD_v0_update_symbols.json"))
    ...
    "compile AgeUSD contract correctly" in {
